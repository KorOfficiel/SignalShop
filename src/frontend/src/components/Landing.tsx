    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0f172a, #1e3a8a, #3b82f6)', fontFamily: 'Inter, Segoe UI, sans-serif', overflow: 'hidden' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: 20 }}>
        <header style={{ textAlign: 'center', padding: '60px 0' }}>
          ...
          <h1 style={{ fontSize: '3rem', margin: '10px 0', color: 'white', fontWeight: 800, letterSpacing: '-1px' }}>SignalShop</h1>
          ...
          <div style={{ marginTop: 30, display: 'flex', gap: 15, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/install" style={{ background: '#2563eb', color: 'white', padding: '14px 28px', borderRadius: 30, textDecoration: 'none', fontWeight: 600, boxShadow: '0 10px 25px rgba(37,99,235,0.5)' }}>
              Télécharger l'application
            </Link>
            <Link to="/login" style={{ background: '#16a34a', color: 'white', padding: '14px 28px', borderRadius: 30, textDecoration: 'none', fontWeight: 600, boxShadow: '0 10px 25px rgba(22,163,74,0.5)' }}>
        ...
        <footer style={{ padding: '30px 0', textAlign: 'center', color: '#94a3b8' }}>
          <p>© 2026 SignalShop — Créé par <a href="https://discord.gg/mvpXXSPeRA" target="_blank" rel="noopener noreferrer" style={{ color: '#fbbf24' }}>KOR</a></p>
        </footer>
      </div>
      <style>{`
        @keyframes float {
